                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        {!isLogin && (
                            <div className="space-y-2">
                                <label htmlFor="username" className="block text-sm font-semibold text-muted-foreground ml-1">
                                    Username
                                </label>
                                <input
                                    id="username"
                        ...
                        {/* Email */}
                        <div className="space-y-2">
                            <label htmlFor="email" className="block text-sm font-semibold text-muted-foreground ml-1">
                                Email Address
                            </label>
                            <input
                                id="email"
                        ...
                        {/* Password */}
                        <div className="space-y-2">
                            <label htmlFor="password" className="block text-sm font-semibold text-muted-foreground ml-1">
                                Password
                            </label>
                        ...
                        {!isLogin && (
                            <div className="space-y-2">
                                <label htmlFor="confirmPassword" className="block text-sm font-semibold text-muted-foreground ml-1">
                                    Confirm Password
                                </label>
                                <div className="relative">
                                    <input
