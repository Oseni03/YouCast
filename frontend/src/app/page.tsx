			...
			<main className="max-w-7xl mx-auto px-6 md:px-10 pt-24 md:pt-32 pb-40">
				<div className="text-left max-w-5xl animate-in fade-in slide-in-from-bottom-8 duration-1000 mt-4 md:mt-12">
					...
					<p className="text-lg md:text-xl text-muted-foreground max-w-2xl mb-10 md:mb-14 leading-relaxed font-normal">
						Automatically convert your video uploads into
						high-quality podcast episodes and distribute them to
				...
				<div
					id="demo"
					className="mt-24 md:mt-40 relative scroll-m-20 animate-in fade-in zoom-in-95 duration-1000 delay-300"
				>
				...
				<div
					id="features"
					className="mt-24 md:mt-40 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 scroll-m-24"
				>
					<div className="text-left p-10 bg-surface-container-lowest rounded-2xl shadow-[0px_24px_48px_rgba(25,28,30,0.06)] hover:-translate-y-2 transition-transform group relative overflow-hidden">
						...
						<p className="text-base text-muted-foreground leading-relaxed">
							Advanced background noise removal and normalization
							for that perfect studio sound, every single time.
						</p>
					...
					<div className="text-left p-10 bg-surface-container-lowest rounded-2xl shadow-[0px_24px_48px_rgba(25,28,30,0.06)] hover:-translate-y-2 transition-transform group relative overflow-hidden">
						...
						<p className="text-base text-muted-foreground leading-relaxed">
							Your content is everywhere instantly. We manage RSS
							feeds, hosting, and platform metadata automatically.
						</p>
						<div className="mt-8 flex items-center gap-2 text-sm font-semibold text-accent opacity-0 group-hover:opacity-100 transition-opacity">
							Learn More <ArrowRight className="size-4" />
						</div>
					...
					<div className="text-left p-10 bg-surface-container-lowest rounded-2xl shadow-[0px_24px_48px_rgba(25,28,30,0.06)] hover:-translate-y-2 transition-transform group relative overflow-hidden">
						...
						<p className="text-base text-muted-foreground leading-relaxed">
							Deep-dive into listener behavior across all
							platforms with our unified, real-time analytics
							engine.
						</p>
						<div className="mt-8 flex items-center gap-2 text-sm font-semibold text-accent opacity-0 group-hover:opacity-100 transition-opacity">
							Learn More <ArrowRight className="size-4" />
