    ...
    return (
        <div className="max-w-4xl mx-auto relative">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/40 backdrop-blur-sm">
                    <div className="bg-surface-container-lowest rounded-3xl p-8 max-w-md w-full shadow-[0px_24px_48px_rgba(25,28,30,0.06)] border border-border">
                        <div className="flex items-center gap-4 mb-6 text-destructive">
                            ...
                            <h4 className="text-2xl font-manrope font-bold tracking-tight">Danger Alert</h4>
                        </div>
            ...
            <header className="mb-6 md:mb-8 pb-4">
                <h2 className="text-3xl font-manrope font-bold text-primary tracking-tight">Account Settings</h2>
                <p className="text-muted-foreground mt-2 font-medium text-sm">Manage your profile and account preferences</p>
            </header>
            ...
            <div className="space-y-8 md:space-y-10">
                <section className="bg-surface-container-lowest border border-border p-6 md:p-10 rounded-3xl shadow-[0px_12px_24px_rgba(25,28,30,0.04)]">
                    <h3 className="text-2xl md:text-3xl font-manrope font-bold mb-8 text-primary tracking-tight">Profile</h3>
                    <div className="flex flex-col md:flex-row gap-8 md:gap-12">
                        <div className="flex flex-col items-center md:items-start gap-4">
                            <div className="size-32 md:size-40 shrink-0 rounded-2xl bg-surface-container-low border border-border flex items-center justify-center overflow-hidden relative group shadow-sm">
                                <img src={creator?.avatar_url || "https://api.dicebear.com/9.x/notionists/svg?seed=" + (creator?.username || "fallback")} alt="Profile" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" referrerPolicy="no-referrer" />
                            ...
                            <button className="text-sm font-semibold text-muted-foreground hover:text-primary transition-colors">Change Photo</button>
                        </div>
                        <div className="flex-1 space-y-6 w-full">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    <label className="block text-sm font-semibold text-muted-foreground ml-1">Display Name</label>
                                    <input
                            ...
                            <div className="space-y-2">
                                <label className="block text-sm font-semibold text-muted-foreground ml-1">Bio</label>
                                <textarea
                ...
                <section className="bg-surface-container-lowest border border-border p-6 md:p-10 rounded-3xl shadow-[0px_12px_24px_rgba(25,28,30,0.04)]">
                    <h3 className="text-2xl md:text-3xl font-manrope font-bold mb-8 text-primary tracking-tight">Subscription</h3>
                    <div className="p-6 md:p-8 bg-surface-container-low rounded-2xl flex flex-col xl:flex-row xl:justify-between items-start xl:items-center gap-6 xl:gap-8">
                        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 md:gap-6 w-full">
                            ...
                            <div>
                                <p className="text-xl md:text-2xl font-manrope font-bold text-primary tracking-tight capitalize">{creator?.plan_tier} Plan</p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full xl:w-auto">
                            <button className="w-full sm:w-auto px-6 py-3 bg-surface-container-high hover:bg-surface-container-highest text-primary rounded-xl text-sm font-semibold transition-colors duration-200">Manage Billing</button>
                            <button className="w-full sm:w-auto px-6 py-3 bg-linear-to-br from-primary to-primary-container text-primary-foreground rounded-xl text-sm font-semibold hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">Upgrade Plan</button>
                        </div>
                    </div>
                </section>

                <section className="bg-surface-container-lowest border border-border p-6 md:p-10 rounded-3xl shadow-[0px_12px_24px_rgba(25,28,30,0.04)]">
                    <h3 className="text-2xl md:text-3xl font-manrope font-bold mb-8 text-primary tracking-tight">Notifications</h3>
                    <div className="space-y-6 md:space-y-8">
                        {[
                            ...
                            <div key={i} className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-border pb-6 md:pb-8 last:border-0 last:pb-0">
                ...
                <section className="bg-destructive/5 p-6 md:p-8 rounded-3xl border border-destructive/20">
                    <h3 className="text-lg md:text-xl font-manrope font-bold mb-3 text-destructive tracking-tight">Danger Zone</h3>
                    <p className="text-sm font-medium text-destructive/80 mb-6 leading-relaxed">Deactivating your account will suspend your access. You can reach out to support to reactivate it later.</p>
                    <button
